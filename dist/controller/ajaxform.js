...
exports.saveStepupdate = exports.updateStep = exports.saveStep = exports.stepEmplist = exports.showStep = void 0;
const connection_1 = __importDefault(require("../config/connection"));
const showStep = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const stepEmplist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.stepEmplist = stepEmplist;
const saveStep = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log('hello');
        ...
        for (let i = 0; i < compname.length; i++) {
            if (compname[i] && desig[i] && todate[i] && fromdate[i])
                yield connection_1.default.promise().query(query5, [insertedId, compname[i], desig[i], todate[i], fromdate[i]]);
        }
        ...
        for (let i = 0; i < refname.length; i++) {
            if (refname[i] && refphone[i] && refrel[i])
                yield connection_1.default.promise().query(query4, [insertedId, refname[i], refphone[i], refrel[i]]);
        }
        ...
        language && language.forEach((e) => __awaiter(void 0, void 0, void 0, function* () {
            if (e === "hindi") {
                if (hread)
                    hread = 1;
                else {
        ...
        tech && tech.forEach((e) => __awaiter(void 0, void 0, void 0, function* () {
            if (e === "php") {
...
const saveStepupdate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.saveStepupdate = saveStepupdate;
